...
public class NBRIClinicalMoveNotification extends AbstractEHRNotification
{
    public NBRIClinicalMoveNotification(Module owner)
    {
        super(owner);
    }

    public NBRIClinicalMoveNotification()
    {
        super();
    }
