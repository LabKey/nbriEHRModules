...
public class NBRIObservationsDataSource extends AbstractDataSource
{
    public NBRIObservationsDataSource(String schema, String query, String categoryText, String primaryGroup, Module module)
    {
